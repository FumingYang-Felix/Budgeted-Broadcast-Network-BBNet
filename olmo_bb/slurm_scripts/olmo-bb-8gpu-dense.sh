#!/bin/bash
#===============================================================================
# OLMo Dense Baseline - 8 GPU (2 nodes × 4 GPUs) for Technical Readiness
...
#SBATCH -o slurm_out/dense-8gpu-%j.out
#SBATCH -e slurm_out/dense-8gpu-%j.err
#SBATCH --job-name=olmo-dense-8gpu
...
echo ""
echo "==============================================================================="
echo "        DENSE BASELINE - 8 GPU Technical Readiness Test                       "
echo "==============================================================================="
echo ""
...
echo "=== Starting Dense Training (8 GPUs) ==="
START_TIME=$(date +%s)
...
srun python -m torch.distributed.run \
    ...
    --save_report slurm_out/report-dense-8gpu-$SLURM_JOB_ID.json
...
if [ -f "slurm_out/report-dense-8gpu-$SLURM_JOB_ID.json" ]; then
    echo "=== Training Report ==="
    cat slurm_out/report-dense-8gpu-$SLURM_JOB_ID.json
fi
